...
const SLASH_COMMANDS = [
  ...
  { cmd: "model", syntax: "/model @agent provider/id", desc: "Change agent model (alias: /add)" },
  { cmd: "add", syntax: "/add @agent provider/id", desc: "Change agent model (alias of /model)" },
  ...
  { cmd: "seats", syntax: "/seats fuse <seat> @a @b…", desc: "Fuse agents onto a shared seat context (solo @a… to detach)" },
]
